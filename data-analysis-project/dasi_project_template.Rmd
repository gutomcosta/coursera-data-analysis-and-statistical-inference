...
```{r relationship_contingency_table_xmarsex_year}
...
```{r degree_and_xamarsex_na_values}
...
```{r execute_inference}
inference(gss_with_degree_and_xmarsex_without_NA_columns$xmarsex, gss_with_degree_and_xmarsex_without_NA_columns$degree, est = "proportion", type = "ht", method = "simulation", alternative = "greater")
```
